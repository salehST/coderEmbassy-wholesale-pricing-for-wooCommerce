  ...
  return `
    <div class="dpp-grid">
      <div class="dpp-hero">
        ...
        <p>Manage dealer price rules by role. Use the theme toggle in the top-right to switch between light and dark mode.</p>
  ...
  return `
    <div class="dpp-pagehead">
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap">
        <button class="dpp-btn dpp-btn-primary" id="dpp-add-price">${icons.plus} Add rule</button>
      </div>
    </div>
    <div class="dpp-card">
...
async function loadPrices() {
  ...
  try {
              ...
              <tr>
                ...
                <td>
                  <div style="display:flex;gap:6px">
                    <button class="dpp-btn dpp-btn-sm dpp-edit-price" data-id="${r.id}" title="Edit">${icons.edit}</button>
    ...
    document.querySelectorAll('.dpp-edit-price').forEach(b => b.addEventListener('click', () => openPriceModal(b.dataset.id)));
