...
/**
 * Visibility – Starter: catalog mode (hide prices and Add to Cart until login) and hide retail-only products from wholesale.
 * No per-product or per-category visibility (Business+).
 */
class Visibility {
